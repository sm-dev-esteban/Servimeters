    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-dark" data-dismiss="modal" data-action="qrcode"><i class="fa fa-qrcode"></i></button>
...
<div class="modal fade" id="viewQrcode">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <p><b>Nota:</b> Para generar este documento asegúrate de haber generado por lo menos una vez la impresión.</p>
                    </div>
                    <div class="col-12 d-flex justify-content-center align-items-center" data-show-qr></div>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i></button>
