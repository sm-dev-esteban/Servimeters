...
(function (global, factory) {
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    ...
    _proto.search = function search() {
      ...
      if (endResults.length === 0) {
        ...
        endResults.each(function (i, result) {
          $__default["default"](SELECTOR_SEARCH_RESULTS_GROUP).append(_this2._renderItem(escape(result.name), encodeURI(result.link), result.path, result.dScript, result.dTitle));
        });
      }
    ...
    _proto._parseItem = function _parseItem(item, path) {
      ...
      var dScript = navLink.data("script");
      var dTitle = navLink.data("title");
      itemObject.name = this._trimText(name);
      itemObject.link = link;
      itemObject.path = path;
      itemObject.dScript = dScript;
      itemObject.dTitle = dTitle;
    ...
    _proto._renderItem = function _renderItem(name, link, path, dScript, dTitle) {
      var _this4 = this;
      ...
      var groupItemElement = $__default["default"]('<a/>', {
        href: `javascript:contentPage('${decodeURIComponent(link)}', ${dTitle ? `'${dTitle}'` : undefined}, ${dScript ? `'${dScript}'` : undefined})`,
      ...
      groupItemElement.on("click", function () {
        $(`[data-widget="sidebar-search"] button`).click(); // cerramos el menu
      });
